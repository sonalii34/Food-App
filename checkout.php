...
if(empty($_SESSION["user_id"]))
{
	header('location:login.php');
                                                ...
                                                $_SESSION["price1"]=$item_total;
												
													if($_POST['submit'])
													{
						
													$SQL="insert into users_orders(u_id,title,quantity,price,res_id) values('".$_SESSION["user_id"]."','".$item["title"]."','".$item["quantity"]."','". $_SESSION["price1"]."','".$item["res_id"]."')";
