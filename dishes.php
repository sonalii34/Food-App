...
<head>
    ...
    <header id="header" class="header-scroll top-header headrom">
        ...
        <div class="page-wrapper">
            ...
            <section class="inner-page-hero bg-image" data-image-src="images/img/pis.png">
            <div class="profile">
                    <div class="container">
                        <div class="row">
  ...
  <!------------------------------------------Menuuuuuuuuuuuuuuuuuu ----------------------------------->
                 ...
                 <div class="menu-widget" id="2">
                           <div class="widget-heading">
                            ...
                            <?php  
									$stmt = $db->prepare("select * from dishes where res_id='$_GET[res_id]'");
									$stmt->execute();
