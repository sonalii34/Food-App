...
<body class="home">
                    ...
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
						...
						if(empty($_SESSION["user_id"])) // if user is not login
						...
						else
							{
                                    ...
                                    echo '<li class="nav-item"><a class="nav-link active" style="padding: 0;"><div class="user-circle">' . $_SESSION["firstLetter"] . '</div></a></li>';
        ...
        <section class="hero bg-image" id="hero">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Whenever, wherever whatsoever! </h1>
                  <div class="bar">
                    <form action="search.php" method="get">
                           <div class="search">
                             <input class="search-input" type="search" placeholder="Search by emoji or dish name" name="dish">
                             <button type="submit"> <span class="material-symbols-outlined" style="color:black">
                                                                   search
                                                             </span> </button>
                           </div>
                        </form>
                                ...
                                while($r=mysqli_fetch_array($query_res))
                                {
                                    ...
                                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                ...
                                                <div class="content">
                                                    <h5><a href="dishes.php?res_id='.$r['res_id'].'">'.$r['title'].'</a></h5>
                                                    <div class="product-name">'.$r['slogan'].'</div>
                                                    <div class="price-btn-block"> <span class="price">Rs'.$r['price'].'</span> <a href="dishes.php?res_id='.$r['res_id'].'" class="btn theme-btn-dash pull-right">Order Now</a> </div>
                                                </div>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const imgElements = document.querySelectorAll('#hero .hero-img');
