	                        ...
	                        if(is_array($row)) 
								{
                                      ...
                                      $_SESSION["firstLetter"] = strtoupper(substr($_SESSION["user_name"], 0, 1));
...
<div class="module form-module">
  ...
  <div class="cta">Not registered?<a href="how_to_register.php" style="color:#5c4ac7;"> Create an account</a></div>
</div>
