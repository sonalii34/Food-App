...
switch($_GET["action"])
 {
	case "add":
		if(!empty($quantity)) {
                                ...
                                $itemArray = array($productDetails->d_id=>array('title'=>$productDetails->title, 'd_id'=>$productDetails->d_id, 'quantity'=>$quantity, 'price'=>$productDetails->price,'res_id'=>$productDetails->res_id));
